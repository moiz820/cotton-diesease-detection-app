...
const App = () => {
  ...
  return (
    <View style={[backgroundStyle, styles.outer]}>
      ...
      />
      <Text style={styles.title}>{'Cotton Disease \nDetection App'}</Text>
      ...
      {(result && label && (
        <View style={styles.mainOuter}>
          <Text style={[styles.space, styles.labelText]}>
            {'Label: \n'}
            <Text style={styles.space}>{label}</Text>
          </Text>
          <Text style={[styles.space, styles.labelText]}>
            {'Confidence: \n'}
        ...
        (image && <Text style={styles.emptyText}>{label}</Text>) || (
          <Text style={styles.emptyText}>
            Use below buttons to select a picture of a Cotton plant leaf.
          </Text>
        )}
